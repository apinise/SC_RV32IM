...
HD_PWD='D:/505_Project/505_RISC_V/project/work/505_RISC_V_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proc_top.tcl
