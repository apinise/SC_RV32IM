...
HD_PWD='D:/505_Project/505_RISC_V/project/work/505_RISC_V_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proc_top.tcl -notrace
